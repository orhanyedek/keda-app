...
export default function MustafaAssistant() {
  ...
  const handleSend = () => {
    ...
    localStorage.setItem("keda_ai_initial_message", input.trim());
            ...
            {open && (
              ...
              >
                <div className="flex items-center justify-between px-4 py-3 border-b border-[hsl(var(--border))]">
                  <div>
                    <p className="text-sm font-semibold" style={{ color: "hsl(var(--foreground))" }}>Mustafa Çakmak</p>
                    <p className="text-xs" style={{ color: "hsl(var(--muted-foreground))" }}>M-03 · Flashcard Modülü</p>
                  </div>
                ...
                <div className="px-4 py-4">
                  <div className="flex gap-3 mb-4">
                    <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 border border-[hsl(var(--border))]">
                      ...
                      <img src="/mustafa.png" alt="Mustafa" className="w-full h-full object-cover object-top" />
                    </div>
