...
export default function SerdarAssistant() {
            ...
            {open && (
              ...
              >
                <div className="flex items-center justify-between px-4 py-3 border-b border-[hsl(var(--border))]">
                  <div>
                    <p className="text-sm font-semibold" style={{ color: "hsl(var(--foreground))" }}>Serdar Durgut</p>
                    <p className="text-xs" style={{ color: "hsl(var(--muted-foreground))" }}>M-04 · Pomodoro Modülü</p>
                  </div>
                ...
                <div className="px-4 py-4">
                  <div className="flex gap-3 mb-4">
                    <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 border border-[hsl(var(--border))]">
                      ...
                      <img src="/serdar.png" alt="Serdar" className="w-full h-full object-cover object-top" />
                    </div>
