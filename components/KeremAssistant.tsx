...
export default function KeremAssistant() {
            ...
            {open && (
              ...
              >
                <div className="flex items-center justify-between px-4 py-3 border-b border-[hsl(var(--border))]">
                  <div>
                    <p className="text-sm font-semibold" style={{ color: "hsl(var(--foreground))" }}>Kerem Mert Duru</p>
                    <p className="text-xs" style={{ color: "hsl(var(--muted-foreground))" }}>M-02 · Podcast Modülü</p>
                  </div>
                ...
                <div className="px-4 py-4">
                  <div className="flex gap-3 mb-4">
                    <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 border border-[hsl(var(--border))]">
                      ...
                      <img src="/kerem.png" alt="Kerem" className="w-full h-full object-cover object-top" />
                    </div>
